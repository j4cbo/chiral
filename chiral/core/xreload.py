...
def xreload(mod):
	...
	reload_count = tmpns.get("__chiral_reload_count__", 0) + 1
	modns["__chiral_reload_count__"] = reload_count
...
def _update(oldobj, newobj):
	...
	if isinstance(newobj, types.ClassType) or isinstance(newobj, type):
